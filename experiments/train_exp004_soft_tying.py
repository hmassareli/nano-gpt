...
while True:
    ...
    if TWO_STAGE_HEAD_UPDATE:
        ...
        # EXP-004: Soft weight tying — anchor head to transpose of embedding
        SOFT_TIE_LAMBDA = 0.05
        tie_loss = SOFT_TIE_LAMBDA * (model.lm_head.weight - model.transformer.wte.weight).float().square().mean()
        tie_loss.backward()
