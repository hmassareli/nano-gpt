...
"""
EXP_TITLE = "EXP-010: Fast Multi-Head (Fused Proj + Head Dropout)"
...
# EXP-010: Fused multi-head output with head dropout
...
class GPT(nn.Module):
    def __init__(self, config):
        ...
        # EXP-010: Fused multi-head output
    ...
    def init_weights(self):
        ...
        # EXP-010: Initialize fused multi-head
    ...
    def num_scaling_params(self):
        ...
        # EXP-010: count all fused multi-head params
    ...
    def setup_optimizer(self, unembedding_lr=0.004, embedding_lr=0.2, matrix_lr=0.02,
        ...
        # EXP-010: all fused multi-head params get unembedding LR
    ...
    def forward(self, idx, targets=None, reduction='mean', head_drop_mask=None):
        ...
        # EXP-010: Fused multi-head with head dropout
        softcap = 15
...
# EXP-010 specific
NUM_OUTPUT_HEADS = 3
OUTPUT_HEAD_DIM = 160    # D_k per subhead (iso-parameter: 3*160*8704 = 4,177,920 ~ baseline 4,194,304)
HEAD_DROP_PROB = 1/3     # drop 1 of 3 heads per step (regularization + compute saving)
...
while True:
    ...
    # Generate head dropout mask (None during eval, or if HEAD_DROP_PROB == 0)
    head_mask = None
    if HEAD_DROP_PROB > 0:
