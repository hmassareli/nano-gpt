...
"""
EXP_TITLE = "EXP-018: 4-Head No GELU + Per-Head CE (4x D->128->V)"
...
# EXP-018: Linear output subhead kept intentionally simple.
...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None, reduction='mean'):
        ...
        # EXP-018: Sum logits from all output subheads and supervise each head individually.
        softcap = 15
