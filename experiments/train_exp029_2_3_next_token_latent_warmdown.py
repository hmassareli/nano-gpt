...
"""
EXP_TITLE = "EXP-029.2.3: Next-Token Latent Prediction (Latent Warmdown)"
...
LATENT_LOSS_LAMBDA = 0.5  # Weight for next-token latent prediction loss
PREDICTOR_HIDDEN_DIM = 512  # Small MLP predictor
LATENT_WARMDOWN_START = 0.3  # Start decaying latent loss after 30% of the budget
LATENT_WARMDOWN_END = 1.0    # Reach zero latent weight by the end of the budget
