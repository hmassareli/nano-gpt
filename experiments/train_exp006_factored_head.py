...
class GPT(nn.Module):
    ...
    def init_weights(self):
        ...
        # EXP-006: Initialize factored head
        n_embd = self.config.n_embd
        torch.nn.init.normal_(self.lm_head_expand.weight, mean=0.0, std=(n_embd ** -0.5))
    ...
    def num_scaling_params(self):
        ...
        lm_head = sum(p.numel() for p in self.lm_head.parameters()) + sum(p.numel() for p in self.lm_head_expand.parameters())
    ...
    def setup_optimizer(self, unembedding_lr=0.004, embedding_lr=0.2, matrix_lr=0.02,
        ...
        lm_head_params = list(self.lm_head.parameters()) + list(self.lm_head_expand.parameters())
