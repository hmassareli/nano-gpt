...
"""
EXP_TITLE = "EXP-017: 2-Head No GELU + Per-Head CE (2x D->256->V)"
...
class GPTConfig:
    ...
    num_output_heads: int = 2
    output_head_dim: int = 256  # D_k per subhead (max rank = 2*256 = 512 = D)
...
# EXP-017: Linear output subhead kept intentionally simple.
...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None, reduction='mean'):
        ...
        # EXP-017: Sum logits from all output subheads and supervise each head individually.
        softcap = 15
...
# EXP-017 specific
NUM_OUTPUT_HEADS = 2
OUTPUT_HEAD_DIM = 256    # D_k per subhead (max rank: 2*256=512=D, params: 2*256*8704=4,456,448)
